...
function changeActionWheelPage(page)
    ...
    if page == 0 then
        ...
        action_wheel.SLOT_6.setItem(item_stack.createItem("minecraft:black_terracotta"))
        action_wheel.SLOT_6.setTitle("Select Second Position")
    ...
    if page == 1 or page == 2 then
        ...
        action_wheel.SLOT_6.setItem(item_stack.createItem("minecraft:red_concrete"))
        action_wheel.SLOT_6.setTitle("Cancel")
        action_wheel.SLOT_6.setFunction(function ()
            changeActionWheelPage(0)
            log("Canceled")
        end)
