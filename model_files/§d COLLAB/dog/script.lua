...
function tick()
    ...
    model.base.BodyDigitigrade.BodyDigi.BodyBlinkFront.setUV(frames[time])
...
function ping.ClothesGreen()
    for i,v in ipairs(underarmor) do
        v.setColor({80/255,255/255,80/255})
    end
    ...
    --model.base.Head.Helmet.underhelmet.setUV({0/texture_width,0/texture_width})
end

--switch underarmor calves and underhelmet to blue

function ping.ClothesBlue()
    for i,v in ipairs(underarmor) do
        v.setColor({100/255,80/255,240/255})
    end
    for i,v in ipairs(calves) do
        v.setColor({100/255,80/255,240/255})
    end
    ...
    --model.base.Head.Helmet.underhelmet.setUV({27/texture_width,0/texture_width})
end

function ping.ClothesWhite()
    for i,v in ipairs(underarmor) do
        v.setColor({255/255,255/255,255/255})
    end
    for i,v in ipairs(calves) do
        v.setColor({255/255,255/255,255/255})
    end
...
--switch underarmor calves and underhelmet to red

function ping.ClothesRed()
    for i,v in ipairs(underarmor) do
        v.setColor({200/255,40/255,40/255})
    end
    for i,v in ipairs(calves) do
        v.setColor({200/255,40/255,40/255})
    end
    ...
    --model.base.Head.Helmet.underhelmet.setUV({54/texture_width,0/texture_width})
end

--switch underarmor calves and underhelmet to cream-ish-y

function ping.ClothesBrown()
    for i,v in ipairs(underarmor) do
        v.setColor({160/255,120/255,102/255})
    end
    for i,v in ipairs(calves) do
        v.setColor({160/255,120/255,102/255}) 
    end
...
function ping.ClothesBlack()
    for i,v in ipairs(underarmor) do
        v.setColor({70/255,70/255,70/255})
    end
    for i,v in ipairs(calves) do
        v.setColor({70/255,70/255,70/255})
    end
    ...
    --model.base.Head.Helmet.underhelmet.setUV({108/texture_width,0/texture_width})
end
...
function player_init()
    network.registerPing("underarmorSwitch")
	network.registerPing("armorSwitch")
	network.registerPing("whirlpool")
	network.registerPing("emissions")
    network.registerPing("undercalvesSwitch")
...
function() 
	...
	action_wheel.SLOT_1.setTitle("Armour "..word1)
	action_wheel.SLOT_1.setItem(item1)
	network.ping("armorSwitch", armored)
end)

function armorSwitch(vale)
	armored = vale
...
--    model.base.Body.chest.cube.setEnabled(armored)
    ...
    model.base.RightLeg.rightlegarmor.leggings.setEnabled(armored)
    model.base.RightLeg.rightlegarmor.leggings2.setEnabled(armored)
...
function() 
	...
	action_wheel.SLOT_2.setTitle("Underarmour "..word2)
	action_wheel.SLOT_2.setItem(item2)
	network.ping("underarmorSwitch", underarmored)
end)
...
function() 
	...
	action_wheel.SLOT_3.setTitle("Undercalves "..word3)
	action_wheel.SLOT_3.setItem(item3)
	network.ping("undercalvesSwitch", undercalves)
end)
...
--action_wheel.SLOT_1.setItem("minecraft:leather_chestplate")
--action_wheel.SLOT_1.setTitle("Toggle Arm Clothing")
--action_wheel.SLOT_1.setFunction(function()
--    togglearms = not togglearms
--    for i,v in ipairs(underarmorarms) do
--        v.setEnabled(togglearms)
--    end
--end)

--"main" underclothes toggle 
--toggleclothes = true
--action_wheel.SLOT_2.setItem("minecraft:leather_leggings")
--action_wheel.SLOT_2.setTitle("Toggle Underarmour Rendering")
--action_wheel.SLOT_2.setFunction(function()
--    toggleclothes = not toggleclothes
--    for i,v in ipairs(underarmor) do
--        v.setEnabled(toggleclothes)
--    end
--end)

--underclothes feet shins toggle

--togglecalves = true
--action_wheel.SLOT_3.setItem("minecraft:leather_boots")
--action_wheel.SLOT_3.setTitle("Toggle Calf Clothing")
--action_wheel.SLOT_3.setFunction(function()
--    togglecalves = not togglecalves
--    for i,v in ipairs(calves) do
--        v.setEnabled(togglecalves)
--    end
--end)
...
--Underhelmet Rendering Toggle using toggleUnderhelm instead of toggle as variable, seems to work much better
---action_wheel.SLOT_1.setItem("minecraft:leather_helmet")
---action_wheel.SLOT_1.setTitle("Toggle Underhelmet Rendering")
---action_wheel.SLOT_1.setFunction(function() toggleUnderhelm = not toggleUnderhelm ping.Underhelmtoggle(toggleUnderhelm) end)

--action_wheel.SLOT_2.setItem("minecraft:leather_leggings")
--action_wheel.SLOT_2.setTitle("Toggle Underarmour Rendering")
--action_wheel.SLOT_2.setFunction(function() toggleUnderarmor = not toggleUnderarmor ping.Clothestoggle(toggleUnderarmor) end)

--action_wheel.SLOT_3.setItem("minecraft:leather_boots")
--action_wheel.SLOT_3.setTitle("Toggle Calf Clothing")
--action_wheel.SLOT_3.setFunction (function() toggleShins = not toggleShins ping.Calftoggle(toggleShins) end)

action_wheel.SLOT_4.setItem("minecraft:green_terracotta")
action_wheel.SLOT_4.setTitle("Green Underarmour")
action_wheel.SLOT_4.setFunction(ping.ClothesGreen)

--action_wheel.SLOT_4.setItem("minecraft:blue_terracotta")
--action_wheel.SLOT_4.setTitle("Blue Underarmour")
--action_wheel.SLOT_4.setFunction(ping.ClothesBlue)

action_wheel.SLOT_5.setItem("minecraft:red_terracotta")
action_wheel.SLOT_5.setTitle("Red Underarmour")
action_wheel.SLOT_5.setFunction(ping.ClothesRed)

--action_wheel.SLOT_7.setItem("minecraft:brown_terracotta")
--action_wheel.SLOT_7.setTitle("Brown Underarmour")
--action_wheel.SLOT_7.setFunction(ping.ClothesBrown)

action_wheel.SLOT_6.setItem("minecraft:black_terracotta")
action_wheel.SLOT_6.setTitle("Black Underarmour")
action_wheel.SLOT_6.setFunction(ping.ClothesBlack)

action_wheel.SLOT_7.setItem("minecraft:white_wool")
action_wheel.SLOT_7.setTitle("White Underarmour")
action_wheel.SLOT_7.setFunction(ping.ClothesWhite)
...
function() 
	...
	action_wheel.SLOT_8.setTitle("Whirlpool Effect "..word8)
	action_wheel.SLOT_8.setItem(item8)
	network.ping("whirlpool", bubbles)
end)

function whirlpool(val)
	bubbles = val
end
--clothes table
...
legs = {model.base.LeftLeg.leftlegarmor.leggings, model.base.Body.Leggings.Armor, model.base.Body.Leggings.ArmorTrim,
    ...
    model.base.Body.Leggings.bone.armor1, model.base.Body.Leggings.bone.Armor1, model.base.BodyDigitigrade.tailonland2.tailarmor}, --model.base.RightLeg.clothes2, model.base.LeftLeg.clothes3 },
...
--	Info: Tail color
tailcolor = {255/255,255/255,255/255}
...
function isInWater()
    ...
    if pos_block ~= nil
	and (pos_block.name == "minecraft:water" 
	or pos_block.name == "minecraft:kelp" 
	or pos_block.name == "minecraft:kelp_plant" 
	or pos_block.name == "minecraft:seagrass" 
	or pos_block.name == "minecraft:tall_seagrass" 
	or pos_block.name == "minecraft:lava" 
	or waterlogged == true) then
        enable_tail = true
        timer = 20
    else
        if timer == 0 then
...
function render(delta)
	if (enable_tail) then
		animateTail((lerp(lastSpeed,speed,delta) * 0.2))
    else
...
function tick()
    if is_sitting_down then
        ...
        rotationOffset = -45
        local result = player.getPos()-vectors.of{math.sin(math.rad(player.getBodyYaw()+rotationOffset)),0,math.sin(math.rad(player.getBodyYaw()+rotationOffset))}*0.5
        uppedLeg[1] = (renderer.raycastBlocks(result, result+vectors.of{0,-0.3,0}, "COLLIDER","NONE") ~= nil)
        
        rotationOffset = 45
        result = player.getPos()-vectors.of{math.sin(math.rad(player.getBodyYaw()+rotationOffset)),0,math.sin(math.rad(player.getBodyYaw()+rotationOffset))}*0.5
