...
--check me up on discord ;)
---GNamimates
--Discord: GNamimates#9366
...
--=====STARTUP STUFF=====--
HOST = keybind.newKey("Host Check", "F25").getKey() == "F25"
...
function tick()
    ...
    --special poses | idle
    if HOST then
        pcall(network.ping, "punched", attackKey.isPressed() or interactKey.isPressed())
