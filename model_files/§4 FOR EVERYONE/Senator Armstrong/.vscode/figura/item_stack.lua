...
---Returns the Item max stack size.
---@return integer
function ItemStack.getMaxCount() end

function ItemStack.getRarity() end

---Returns true if the item is enchantable.
---@return boolean
...
---Returns true if the item can be damaged
---@return boolean
...
---used for andvil XP calculations
---@return number
function ItemStack.getRepairCost() end

---returns the time in ticks that youre going to spend using the item before it consumes/activate
---@return number
function ItemStack.getMaxUseTime() end

---returns this item id and nbt formatted the same way as vanilla commands
---@return any
