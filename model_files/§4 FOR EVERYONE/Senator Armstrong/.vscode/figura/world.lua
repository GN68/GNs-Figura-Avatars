...
---Returns its id, eg: "minecraft:taiga".
---@return string
function Biome.getID() end

---Returns its category, eg: "forest".
---@return string
...
---returns its rain type, `"none"` or `"rain"` or `"snow"`.
---@return rainType
function Biome.getPrecipitation() end

---Returns the biome sky color.
---@return VectorColor
...
---Returns a player table of each player in your rendering range, except for players without tracking.
---@return Player[]
...
---Returns a table of the block entity data that you client have (skull owner / banner patterns / etc).
---@return table
