...
---Returns true if the entity has an avatar.
---@return boolean
function LivingEntity.hasAvatar() end

---@return boolean
function LivingEntity.isSprinting() end
...
---Sets the stored value form the player.
---@param key any
---@param value any
function Player.storeValue(key,value) end

---@alias playerModelType
---| '"slim"'
---| '"default"'

---returns the player model type.  
---`"slim"` or `"default"`
---@return playerModelType
function Player.getModelType() end

---Returns the targeted entity, nil if none
---@return table
