...
---Returns the Position of the group in the current playing animation(s).
---@return VectorPos
function CustomModelPart.getAnimPos() end

---Returns the Rotation of the group in the current playing animation(s).
---@return Vector3
function CustomModelPart.getAnimRot() end

---Returns the Scale of the group in the current playing animation(s).
---@return Vector3
...
---## Item Rendering  
---inserts stuff to render, example:  
---
---model.part.addRenderTask("ITEM", "My Cool Axe", "iron_axe", "THIRD_PERSON_LEFT_HAND")
---(type, task name, the item or block or text, (if its item) render mode, emissive, pos, rot, scale, custom render layer)
---@param render_type renderTaskType
---@param render_task_name string
---@param item_block_text ItemID | BlockID | string
---@param item_mode itemRenderMode
---@param emissive boolean
---@param pos Vector3
---@param rot Vector3
---@param scale Vector3
---@param custom_render_layer string
function CustomModelPart.addRenderTask(render_type, render_task_name, item_block_text, item_mode, emissive, pos, rot, scale, custom_render_layer) end

---Returns the Render task.
---@param render_task_name string
---@return renderTask[]
function CustomModelPart.getRenderTask(render_task_name) end

---Removes the existing Render task.
---@param render_task_name string
function CustomModelPart.removeRenderTask(render_task_name) end
