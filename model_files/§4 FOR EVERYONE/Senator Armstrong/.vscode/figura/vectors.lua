...
---return (vector) after it's been rotated around (axis) by (angle) degrees
---@param vector Vector
---@param axis Vector
---@param angle number
function Vector.rotateAroundAxis(vector, axis, angle) end

---returns an {x, y, z} Euler angles representation of the rotation around (axis) by (angle) degrees
---@param axis Vector
---@param angle number
function Vector.axisAngleToEuler(axis, angle) end
---Vector6 ⇐ Vector
---***
