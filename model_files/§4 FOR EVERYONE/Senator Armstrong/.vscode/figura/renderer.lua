...
---Returns the VIEWER's camera rot.
---@return Vector3
...
---Toggles the rendering of the custom player head.
function renderer.setRenderPlayerHead(toggle) end

---Returns true if the custom player head is enabled. 
---@return boolean
